      ...
      <nav className="nav-container">
        ...
        <div className="menu">
          ...
          <ul className={isOpen ? 'show open' : 'hide'}>
            ...
            <li>
              <Link className="nav-ul-link" to="/createBlog">Create Blog</Link>
            </li>
            <li>
              <Link className="nav-ul-link" to="/login">Login</Link>
            </li>
            <li>
              <Link className="nav-ul-link" to="/signup">Sign up</Link>
            </li>
          </ul>
        </div>
      </nav>
